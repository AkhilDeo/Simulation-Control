...
print("psm1 num joints: " + str(num_joints_psm1))
print("psm2 num joints: " + str(num_joints_psm2))
print("psm1 children: " + str(children_names_psm1))
print("psm2 children: " + str(children_names_psm2))
